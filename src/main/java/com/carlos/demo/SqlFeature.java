...
*/
/*
 TODO [Reverse Engineering] create field to map the 'sub_feature_id' column
 Available actions: Define target Java type | Uncomment as is | Remove column mapping
    @Column(name = "sub_feature_id", columnDefinition = "character_data")
    private Object subFeatureId;
*/
/*
 TODO [Reverse Engineering] create field to map the 'sub_feature_name' column
 Available actions: Define target Java type | Uncomment as is | Remove column mapping
    @Column(name = "sub_feature_name", columnDefinition = "character_data")
